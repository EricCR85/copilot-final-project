...
`}
        ...
        <section className="bg-white p-6 rounded-lg shadow mb-10 border-l-4 border-green-400">
          ...
          <div className="border-2 border-green-400 rounded p-4 bg-green-50">
            ...
            <div className="mt-4 flex items-center gap-3 rounded-lg border border-green-200 bg-white p-4">
              <span className="text-sm font-medium text-gray-700">Notifications</span>
              <NotificationBadge count={120} maxCount={99} />
            </div>

            <div className="mt-4 rounded-lg border border-green-200 bg-white p-4">
              <ProgressBar value={72} label="Profile completion" />
            </div>
